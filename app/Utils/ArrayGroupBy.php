...
class ArrayGroupBy
{
    ...
    public function groupByField($group_field)
    {
        ...
        $grouped = call_user_func_array("\\App\\Utils\\ArrayGroupBy::groupByFieldDeep", $group_by_field_params);
    ...
    public static function groupByFieldDeep($arr, $key, $callback = null)
    {
        ...
        if (func_num_args() > 3) {
            ...
            foreach ($grouped as $key => $value) {
                ...
                $grouped[$key] = call_user_func_array("\\App\\Utils\\ArrayGroupBy::groupByFieldDeep", $params);
            }
        }
        return $grouped;
    }
    ...
    public static function getDeepestArray($array)
    {
        ...
        foreach ($array as $arr) {
            if (!is_array($arr)) {
                ...
                $sub_result = call_user_func("\\App\\Utils\\ArrayGroupBy::getDeepestArray", $arr);
